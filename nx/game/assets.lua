...
for i, filename in ipairs(love.filesystem.getDirectoryItems("assets/images")) do
...
for i, filename in ipairs(love.filesystem.getDirectoryItems("assets/sounds")) do
